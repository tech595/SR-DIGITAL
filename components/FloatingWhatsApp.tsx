...
const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <a 
      ...
      className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-emerald-500 rounded-full flex items-center justify-center text-white shadow-2xl pulse-whatsapp emerald-glow hidden md:flex transition-transform hover:scale-110 active:scale-95"
